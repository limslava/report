...
- Маршрут согласования: проверка руководителя СБ, затем параллельные решения юриста, главного бухгалтера и финансового директора, после чего документ передается офис-менеджеру на физическую подпись.
...
2. Руководитель СБ принимает первое решение по договору.
3. После руководителя СБ договор одновременно поступает юристу, главному бухгалтеру и финансовому директору.
4. После завершения трех параллельных решений офис-менеджер получает задачу `Передача на подпись`.
