...
type Props = {
  ...
  /** id записи; для несохранённой карточки undefined — секция покажет подсказку */
...
export default function AttachmentsSection({ entityType, entityId, kinds, canEdit, onError, onSuccess }: Props) {
