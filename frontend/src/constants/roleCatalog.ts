...
export const ROLE_CATALOG: RoleCatalogEntry[] = [
  ...
  { value: 'doc_manager_vvo', label: 'Менеджер документационного отдела', region: 'vvo', dept: 'Диспетчерский отдел', desc: 'Реестр: просмотр всего, правка ставок, НДС, пропусков, простоя, доп. адреса, заказа на ТС, отправки счёта, доп. тонны, пломбы, перецепа и замечаний к водителю.' },
