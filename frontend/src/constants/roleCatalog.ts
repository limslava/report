...
export const ROLE_CATALOG: RoleCatalogEntry[] = [
  ...
  { value: 'secretary', label: 'Офис-менеджер', region: 'all', dept: 'Офис', desc: 'Согласование договоров: регистрация и архив; реестр диспетчерского отдела (просмотр, без денег).' },
  ...
  { value: 'head_hr', label: 'Руководитель отдела кадров', region: 'all', dept: 'Отдел кадров', desc: 'Графики работы всех отделов, HR-модуль, реестр диспетчерского отдела (просмотр, без денег).' },
  { value: 'hr_specialist', label: 'Специалист отдела кадров', region: 'all', dept: 'Отдел кадров', desc: 'Графики работы всех отделов, HR-модуль, реестр диспетчерского отдела (просмотр, без денег).' },
  ...
  // ── Владивосток ──
  { value: 'head_sales', label: 'Руководитель отдела продаж', region: 'vvo', dept: 'Отдел продаж', desc: 'Все показатели (просмотр), сводный отчёт; инициатор договоров; реестр диспетчерского отдела (ведение).' },
  { value: 'manager_sales', label: 'Менеджер по продажам', region: 'vvo', dept: 'Отдел продаж', desc: 'Все показатели (просмотр), сводный отчёт; инициатор договоров; реестр диспетчерского отдела (ведение).' },
  { value: 'manager_extra', label: 'Менеджер доп.услуг', region: 'vvo', dept: 'Отдел продаж', desc: 'Показатели «Доп.услуги» (ввод); инициатор договоров; реестр диспетчерского отдела (ведение).' },
  ...
  { value: 'manager_ktk_vvo', label: 'Диспетчер КТК Владивосток', region: 'vvo', dept: 'Диспетчерский отдел', desc: 'Диспетчерский журнал заявок, графики КТК, справочники (ред.), печатные формы.' },
  { value: 'doc_manager_vvo', label: 'Менеджер документационного отдела', region: 'vvo', dept: 'Диспетчерский отдел', desc: 'Реестр диспетчерского отдела (полное ведение).' },
  { value: 'bdd_specialist_vvo', label: 'Специалист по БДД Владивосток', region: 'vvo', dept: 'Диспетчерский отдел', desc: 'Учёт топлива и нормы, справочник «Наша организация» (ведение), реестр (просмотр без денег), график контейнеровозов и автовозов (факт, просмотр).' },
  { value: 'garage_head_vvo', label: 'Начальник гаража Владивосток', region: 'vvo', dept: 'Гараж', desc: 'График автослесарей, график контейнеровозов и автовозов (факт, просмотр), справочники (просмотр).' },
  ...
  { value: 'manager_ktk_mow', label: 'Диспетчер КТК Москва', region: 'mow', dept: 'Диспетчерский отдел', desc: 'Графики КТК, справочники (ред.).' },
