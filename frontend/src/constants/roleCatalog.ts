...
export const ROLE_CATALOG: RoleCatalogEntry[] = [
  ...
  { value: 'secretary', label: 'Офис-менеджер', region: 'all', dept: 'Офис', desc: 'Реестр диспетчерского отдела (просмотр, без денег).' },
  { value: 'security', label: 'Руководитель СБ', region: 'all', dept: 'Служба безопасности', desc: 'График сторожей.' },
  { value: 'head_hr', label: 'Руководитель отдела кадров', region: 'all', dept: 'Отдел кадров', desc: 'Графики работы всех отделов, реестр диспетчерского отдела (просмотр, без денег).' },
  { value: 'hr_specialist', label: 'Специалист отдела кадров', region: 'all', dept: 'Отдел кадров', desc: 'Графики работы всех отделов, реестр диспетчерского отдела (просмотр, без денег).' },
  // ── Владивосток ──
  { value: 'head_sales', label: 'Руководитель отдела продаж', region: 'vvo', dept: 'Отдел продаж', desc: 'Все показатели (просмотр), сводный отчёт; реестр диспетчерского отдела (ведение).' },
  { value: 'manager_sales', label: 'Менеджер по продажам', region: 'vvo', dept: 'Отдел продаж', desc: 'Все показатели (просмотр), сводный отчёт; реестр диспетчерского отдела (ведение).' },
  { value: 'manager_extra', label: 'Менеджер доп.услуг', region: 'vvo', dept: 'Отдел продаж', desc: 'Показатели «Доп.услуги» (ввод); реестр диспетчерского отдела (ведение).' },
