...
export const ROLE_CATALOG: RoleCatalogEntry[] = [
  ...
  { value: 'deputy_chief_accountant', label: 'Зам. главного бухгалтера', region: 'all', dept: 'Бухгалтерия', desc: 'Права главного бухгалтера; шаг бухгалтерии назначается заму, когда главбух неактивен.' },
