...
router.get('/reports/tech-dashboard', authorizeRole('admin', 'director', 'general_director', 'financer', 'manager_sales', 'head_sales', 'head_ktk_vvo'), getPlanningTechDashboard);
