...
router.delete('/models/:id', authorizeRole(...FUEL_ROLES), asyncHandler(deleteVehicleModel));
...
router.delete('/vehicles/:id', authorizeRole(...DIRECTORY_ROLES), asyncHandler(deleteVehicle));
...
router.delete('/trailers/:id', authorizeRole(...DIRECTORY_ROLES), asyncHandler(deleteTrailer));
...
router.delete('/employees/:id', authorizeRole(...DIRECTORY_ROLES), asyncHandler(deleteEmployee));
