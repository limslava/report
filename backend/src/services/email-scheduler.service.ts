...
function normalizeMetricName(metricCode: string, name: string): string {
  const fullNameByCode: Record<string, string> = {
    ...
    ktk_vvo_fact_move_own: 'Собственные ТС',
    ktk_vvo_fact_move_hired: 'Наемные ТС',
    ...
    ktk_mow_fact_move_own: 'Собственные ТС',
    ktk_mow_fact_move_hired: 'Наемные ТС',
    ...
    auto_truck_sent_own: 'в т.ч. Собственные ТС',
    auto_truck_sent_hired: 'в т.ч. Наемные ТС',
