  ...
  async bootstrapCatalog(): Promise<void> {
    ...
    const metricsBySegment: Record<PlanningSegmentCode, Array<Omit<PlanningMetric, 'id' | 'segment' | 'values' | 'createdAt' | 'updatedAt'>>> = {
      [PlanningSegmentCode.KTK_VVO]: [
        ...
        this.metricSeed('ktk_vvo_fact_move_own', 'Собственные ТС', true, PlanningMetricValueType.INT, PlanningMetricAggregation.SUM, null, 21),
        this.metricSeed('ktk_vvo_fact_move_hired', 'Наемные ТС', true, PlanningMetricValueType.INT, PlanningMetricAggregation.SUM, null, 22),
      ...
      [PlanningSegmentCode.KTK_MOW]: [
        ...
        this.metricSeed('ktk_mow_fact_move_own', 'Собственные ТС', true, PlanningMetricValueType.INT, PlanningMetricAggregation.SUM, null, 21),
        this.metricSeed('ktk_mow_fact_move_hired', 'Наемные ТС', true, PlanningMetricValueType.INT, PlanningMetricAggregation.SUM, null, 22),
      ...
      [PlanningSegmentCode.AUTO]: [
        ...
        this.metricSeed('auto_debt_delta', 'Δ ДЗ/КЗ', false, PlanningMetricValueType.CURRENCY, PlanningMetricAggregation.FORMULA, 'AUTO_DEBT_DELTA', 250),
      ],
